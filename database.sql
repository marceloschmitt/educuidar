...
CREATE TABLE IF NOT EXISTS alunos (
    ...
    estabelecimento_ensino_fundamental TEXT NULL,
    monitoria_atendimento_reprovacao_fundamental TEXT NULL,
    deficiencia_necessidade_especifica TEXT NULL,
    necessidade_adequacao_aprendizagem TEXT NULL,
    medidas_disciplinares TEXT NULL,
    bullying TEXT NULL,
    maiores_dificuldades TEXT NULL,
    acesso_internet_casa TEXT NULL,
    local_estudo TEXT NULL,
    rotina_estudo_casa TEXT NULL,
    habito_leitura TEXT NULL,
    atividades_extracurriculares TEXT NULL,
    acompanhamento_tratamento_especializado TEXT NULL,
    alergias TEXT NULL,
...
-- ALTER TABLE alunos ADD COLUMN cpf VARCHAR(14) NULL AFTER numero_matricula;
-- ALTER TABLE alunos ADD INDEX idx_cpf (cpf);
-- INSERT INTO tipos_eventos (nome, cor, ativo)
-- SELECT 'Falta (registro automático)', 'danger', 1
-- FROM DUAL
-- WHERE NOT EXISTS (
--     SELECT 1 FROM tipos_eventos WHERE nome = 'Falta (registro automático)'
-- );

...
console.log('DEBUG: modalAluno existe?', document.getElementById('modalAluno'));

// Garantir scroll e fontes no modal de aluno
document.addEventListener('DOMContentLoaded', function() {
    ...
    console.log('DEBUG: modalAluno encontrado no DOMContentLoaded?', modalAluno);
    
    if (modalAluno) {
        console.log('DEBUG: Adicionando event listener ao modal');
        
        modalAluno.addEventListener('shown.bs.modal', function() {
            console.log('DEBUG: Modal de aluno foi aberto (shown.bs.modal)');
            ...
            if (modalBody) {
                ...
                console.log('DEBUG: Estilos aplicados. fontSize:', modalBody.style.fontSize);
            }
            ...
            console.log('DEBUG: Todos os estilos aplicados!');
        });
    } else {
        console.error('DEBUG: modalAluno NÃO encontrado!');
    }
});
</script>

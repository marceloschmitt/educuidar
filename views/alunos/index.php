                ...
                <div class="table-responsive">
                    <table class="table table-hover">
                        ...
                        <tbody>
                            ...
                            <?php
                            $aluno_json_data = $a;
                            if (array_key_exists('cpf', $aluno_json_data)) {
                                $aluno_json_data['cpf'] = $aluno_json_data['cpf'] !== null && $aluno_json_data['cpf'] !== ''
                                    ? (string) $aluno_json_data['cpf']
                                    : '';
                            }
                            $aluno_json_attr = htmlspecialchars(
                                json_encode($aluno_json_data, JSON_UNESCAPED_UNICODE | JSON_UNESCAPED_SLASHES),
                                ENT_QUOTES,
                                'UTF-8'
                            );
                            ?>
                            <tr class="aluno-row" data-aluno="<?php echo $aluno_json_attr; ?>">
                                <td>
                                    <?php if (!empty($a['foto'])): ?>
                    ...
                    <div class="row">
                        <div class="col-md-8">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="mb-3">
                                        <label for="modal_cpf" class="form-label">CPF</label>
                                        <input type="text" class="form-control form-control-sm" id="modal_cpf" name="cpf"

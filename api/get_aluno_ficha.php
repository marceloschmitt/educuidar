...
// Garante CPF como string (evita perda de zeros à esquerda no JSON)
if (array_key_exists('cpf', $aluno)) {
    $aluno['cpf'] = ($aluno['cpf'] !== null && $aluno['cpf'] !== '')
        ? (string) $aluno['cpf']
        : '';
}

echo json_encode($aluno, JSON_UNESCAPED_UNICODE | JSON_UNESCAPED_SLASHES);
